...
class YOLOv7:
    ...
    def detect(self, image):
        ...
        outputs = self.net.forward(self.output_names)[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='video/1221_jpg.rf.f5ec5ba547c9ee11c00e7dbdf870099c.jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default='cfg/custom_training/model/best.onnx',
                        help="onnx filepath")
