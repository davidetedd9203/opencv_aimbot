...
net = cv2.dnn.readNetFromONNX("cfg/deploy/yolov7.onnx")
...
# # Get rect of Window
# hwnd = win32gui.FindWindow(None, 'Film e TV')
...
#     print(np.argmax(layerOutputs[0]))
#     boxes = []
#     confidences = []
#
#     for output in layerOutputs[0]:
...
#                 cv2.rectangle(frame, (x, y), (x + box[2], y + box[3]), (255, 255, 255), 2)
#                 boxes.append(box)
